...
st.set_page_config(page_title="Green Efficiency Calculator", page_icon="🔋", layout="wide")
...
if submitted:
    if not os.getenv("OPENAI_API_KEY"):
        st.error("OpenAI API key not found in environment (.env). Please add OPENAI_API_KEY to your .env file.")
    else:
        payload = {
